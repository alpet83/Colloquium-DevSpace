...
- In structured tasks that require numeric output, verify arithmetic consistency before finalizing.
- If output contains both an expression and a computed value, ensure they match exactly.
...
- Do not trade correctness for speed in deterministic JSON tasks.
